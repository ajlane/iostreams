...
public abstract class AbstractIOStreamFilter<T> implements IOStreamFilter<T>
{
     ...
     * <p>
     * If all subsequent values in the {@code IOStream} should be skipped, for efficiency, wrap your return value with
     * a
     ...
     * <p>
     * This method sets a hidden variable on the base class. Once set, the base class will advise the {@code IOStream}
     * to terminate early by modifying the result of calls to {@link IOStreamFilter#apply}.
     * <p>
     * <i>A {@code IOStreamFilter} can advise that a {@code IOStream} terminate early, but cannot force it to.</i> In
     * some cases (like when using {@link IOStreamFilters#invert}) filters will be asked to filter values even after
     * they have advised termination.
     * <p>
